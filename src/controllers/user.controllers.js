...
const registerUser = asyncHandler(async (req,res)=>{
    ...
    const {fullname,email,username,paswword} = req.body
     ...
     */
    if (
        [fullname,email,username,paswword].some((field)=>{
         field?.trim() === ""})
    ){
    ...
    const CoverageImage =  await uploadOnCloudinary(coverImageLocalPath)
